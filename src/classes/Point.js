...
class Point {
    ...
    update(orientation) {
        let { x, y, z } = this.rotateAroundAxis(this.base, orientation.axis.unit(), orientation.angle);
        this.x = x;
        this.y = y;
        this.z = z;
    }
    ...
    rotateAroundAxis(point, unitVector, alpha) {
        ...
        const qA = new Quaternion(cA, sA * unitVector.x, sA * unitVector.y , sA * unitVector.z);
